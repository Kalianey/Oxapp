...
/**
 * Created by kalianey on 21/03/2016.
 */
public class UIParallaxNestedScroll extends NestedScrollView {
    public UIParallaxNestedScroll(Context context) {
        super(context);
    }
    ...
    public UIParallaxNestedScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public UIParallaxNestedScroll(Context context, AttributeSet attrs, int defStyle) {
